  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      >
        <div className="container-lg py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center w-10 h-10 rounded-xl bg-muted/50 hover:bg-accent transition-colors"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-background/95 backdrop-blur-xl border-b shadow-lg">
            <nav className="container-lg py-4 flex flex-col gap-2">
              <a
                href="#features"
                onClick={() => setMobileMenuOpen(false)}
                className="font-medium px-4 py-3 rounded-xl transition-colors text-muted-foreground hover:text-foreground hover:bg-accent"
              >
                Features
              </a>
              <a
              ...
              <Link
                href="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="font-medium px-4 py-3 rounded-xl transition-colors text-foreground hover:bg-accent"
              >
                Sign In
              </Link>
            </nav>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center bg-background overflow-hidden">
        <div className="container-lg relative z-10 pt-24 sm:pt-32 pb-16 sm:pb-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center min-h-[60vh] lg:min-h-[70vh]">
            ...
            <div className="flex flex-col items-center justify-center text-center px-2 sm:px-4">
              <h1 className="hero-title text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold text-foreground leading-tight mb-4 sm:mb-6 opacity-0">
                ...
                <br className="hidden sm:block" /><span className="sm:hidden"> </span>Starts Here
              </h1>

              <p className="hero-subtitle text-base sm:text-lg md:text-xl text-muted-foreground mb-8 sm:mb-10 max-w-lg mx-auto opacity-0">
                Get personalized university recommendations, application guidance, and visa support - all powered by AI.
              </p>

              <div className="hero-buttons flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full sm:w-auto opacity-0">
                <Link
                  href="/signup"
              ...
              {/* Trust badges */}
              <div className="mt-8 sm:mt-12 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-muted-foreground text-xs sm:text-sm">
        ...
        <div className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <ChevronDown className="h-6 w-6 sm:h-8 sm:w-8 text-primary/50" />
        </div>
      </section>

      {/* Stats Section */}
      <section ref={statsRef} className="py-12 sm:py-16 bg-card border-b">
        <div className="container-lg">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {stats.map((stat, i) => (
              <div key={i} className="stat-item text-center opacity-0">
                <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl gradient-primary-subtle mb-3 sm:mb-4">
      ...
      <section ref={stepsRef} id="how-it-works" className="section bg-background">
        <div className="container-lg">
          <div className="steps-header text-center mb-10 sm:mb-16 opacity-0">
          ...
          <div className="steps-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {steps.map((step, i) => (
              <div
                key={i}
                className="step-card relative opacity-0"
              >
                <div className="bg-card rounded-2xl p-5 sm:p-8 h-full border hover:border-primary/30 hover:shadow-lg transition-all duration-300">
                  <div className="text-4xl sm:text-5xl font-bold text-primary/10 mb-3 sm:mb-4">{step.number}</div>
      ...
      <section ref={featuresRef} id="features" className="section bg-muted/50">
        <div className="container-lg">
          <div className="features-header text-center mb-10 sm:mb-16 opacity-0">
            <span className="inline-block px-3 sm:px-4 py-1.5 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium mb-3 sm:mb-4">
              Powerful Features
            </span>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-3 sm:mb-4">
          ...
          <div className="features-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {features.map((feature, i) => (
              <div
                key={i}
                className="feature-card group bg-card rounded-2xl p-5 sm:p-8 border hover:border-primary/30 hover:shadow-xl cursor-pointer transition-all duration-300 opacity-0"
                onMouseEnter={() => setActiveFeature(i)}
              >
                <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-4 sm:mb-5 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300`}>
      ...
      <section ref={ctaRef} className="section gradient-primary relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="cta-orb-1 absolute top-0 left-1/4 w-32 sm:w-64 h-32 sm:h-64 bg-white/10 rounded-full blur-3xl" />
          <div className="cta-orb-2 absolute bottom-0 right-1/4 w-32 sm:w-64 h-32 sm:h-64 bg-[#0984e3]/20 rounded-full blur-3xl" />
        </div>

        <div className="container-lg relative z-10 text-center px-4">
          <div className="cta-content max-w-3xl mx-auto opacity-0">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 sm:gap-3 bg-white text-primary font-bold py-3 sm:py-4 px-6 sm:px-10 text-base sm:text-lg rounded-xl shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 hover:scale-105"
            >
              Get Started Free
      ...
      <section ref={faqRef} className="section bg-background">
        <div className="container-lg max-w-3xl">
          <div className="faq-header text-center mb-8 sm:mb-12 opacity-0">
            <span className="inline-block px-3 sm:px-4 py-1.5 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium mb-3 sm:mb-4">
              FAQ
            </span>
            ...
            {faqs.map((faq, i) => (
              ...
              >
                <summary className="flex items-center justify-between p-4 sm:p-6 cursor-pointer list-none">
                  <span className="font-semibold text-sm sm:text-lg pr-3 sm:pr-4">{faq.q}</span>
                  <ChevronDown className="h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground transition-transform group-open:rotate-180 flex-shrink-0" />
                </summary>
      ...
      <footer className="bg-card border-t">
        <div className="container-lg py-10 sm:py-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12">
            <div className="col-span-2">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
